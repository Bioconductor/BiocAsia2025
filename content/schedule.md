...
<style>
  .schedule-grid{width:100%;border-collapse:collapse;font-size:1.5rem;line-height:1.45;text-align:center}
  .schedule-grid th,.schedule-grid td{border:1px solid #d1d5db;padding:14px 16px;vertical-align:middle}
  .schedule-grid th{background:#eef2f7;text-align:center}
  .time-col{white-space:nowrap;font-weight:700;width:14%}
...
<table class="schedule-grid">
  ...
  <tbody>
    <tr>
      <td class="time-col">08:30–09:00</td>
    ...
    <!-- Afternoon block -->
    <tr>
      <td class="time-col">13:30–15:00</td>
