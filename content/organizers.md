...
<table style="width: 100%; table-layout: fixed; border-collapse: separate; border-spacing: 0 25px;">
  <tr>
    ...
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/StefanoMangiola.jpeg" alt="Photo of Stefano Mangiola" style="max-width: 150px; height: 150px;"><br>
    ...
    <!-- Stevie -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/SteviePederson.png" alt="Photo of Stephen Stevie Pederson" style="max-width: 150px; height: 150px;"><br>
    ...
    <!-- Ellis -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/EllisPatrick.png" alt="Photo of Ellis Patrick" style="max-width: 150px; height: 150px;"><br>
    ...
    <!-- Malvika -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/MalvikaKharbanda.png" alt="Photo of Malvika Kharbanda" style="max-width: 150px; height: 150px;"><br>
  ...
  <tr>
    <!-- Lori -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/LoriShepherd.png" alt="Photo of Lori Shepherd" style="max-width: 150px; height: 150px;"><br>
    ...
    <!-- Kozo -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/KozoNishida.jpeg" alt="Photo of Kozo Nishida" style="max-width: 150px; height: 150px;"><br>
    ...
    <!-- Maria Doyle -->
    <td style="text-align: center; vertical-align: top; width: 25%; padding-bottom: 25px;">
      <img src="../img/organizers/MariaDoyle.jpeg" alt="Photo of Maria Doyle" style="max-width: 150px; height: 150px;"><br>
      <a href="https://github.com/mblue9"><b>Maria Doyle</b></a><br>
